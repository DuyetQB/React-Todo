...
export default function TodoItem(props) {
  ...
  const textDescription = props.valueDescription;
  const handletextDesc = props.handleValueDescription;
  const iconStyle = {
    marginLeft: '20px',
    cursor: 'pointer',
  };
    ...
    <>
      <div className="content">
        <div className="wrap-list">
          <input
            type="checkbox"
            onClick={tonggleCheck}
            style={{cursor: 'pointer'}}
          />
          <li key={props.key} style={listStyle}>
            {props.value}
          </li>
        </div>
          ...
          {openEdit && (
            <>
              ...
              <div className="wrap-edit">
                ...
                <Textarea onChange= {valueDescription} placeholder={textDescription}/>
                <div className="wrap-btn">
                  <button onClick={saveItem} className="btn btn-save">
                    save
                  </button>
                  <button
